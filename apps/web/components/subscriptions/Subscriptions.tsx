...
export function Subscriptions({
  ...
  const fetchData = React.useCallback(async () => {
    ...
    const mapped: Subscription[] = (aggregated || []).map((s) => ({
      ...
      frequency: "monthly",
      confidence:
        s.confidence_avg && s.confidence_avg >= 0.8
          ? "high"
          : s.confidence_avg && s.confidence_avg >= 0.5
            ? "medium"
            : "low",
  ...
  return (
    <Card
      className={cn(
        "w-full border shadow-lg bg-background h-full flex flex-col",
        className,
      )}
    >
      <CardHeader>
            ...
            {isDetecting ? (
              ...
              <>
                ...
                <p className="text-muted-foreground mt-1 max-w-sm">
                  Detect subscriptions from your transactions for the selected
                  date range.
                </p>
                <div className="mt-4">
                  <Button
          ...
          <section>
            ...
            <p className="text-5xl font-light tracking-tight">
              ...
              <span className="font-bold">
                {totalMonthly.toFixed(2).split(".")[0]}
              </span>
              <span className="text-2xl font-bold">
                .{totalMonthly.toFixed(2).split(".")[1]}
              </span>
